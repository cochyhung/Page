...
url = ' https://gauprovip.000webhostapp.com/key.htm?key='+key
token_mneylink = '441b6dedb82de03ceb010dc38df53bc3e96ca517'
mneylink = requests.get(f'https://mneylink.com/api?api={token_mneylink}&url={url}').json()
if mneylink['status']=="error": 
	print(mneylink['message'])
	quit()
else:
	link_key=mneylink['shortenedUrl']
print('\033[1;36mLưu Ý Key Thay Đổi Mỗi Ngày')
print('\033[1;33mLink Để Vượt Key Là:' '\033[1;35m'+link_key)
keynhap = input('\033[1;31mKey Đã Vượt Là: \033[1;34m')
if keynhap == key:
    print('\033[1;33mKey Đúng Mời Bạn Dùng Tool')
else:
    print("\033[1;31mKey Sai Vui Lòng Kiểm Tra Lại")
    quit()
